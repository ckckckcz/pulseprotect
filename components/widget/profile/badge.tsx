...
const badges = [
  ...
  },
  {
    id: 3,
    name: "Ahli Farmasi",
    description: "Badge prestise untuk pengguna dengan keahlian tinggi dalam identifikasi obat",
    points: 500,
    icon: Award,
    color: "bg-teal-700",
    earned: false,
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <div className="text-sm text-gray-500">Total Badge Tersedia</div>
            </div>
          </div>
        </div>
            ...
            return (
              <Card
                ...
                className={`relative overflow-hidden transition-all duration-300 rounded-xl hover:shadow-lg hover:-translate-y-1 bg-white border border-gray-200 ${
                  badge.earned ? "ring-2 ring-teal-200 shadow-md" : ""
                }`}
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2">
                      {badge.earned && (
                        <div className="bg-teal-100 text-teal-700 text-xs px-2 py-1 rounded-full font-semibold">
                          DIRAIH
                        </div>
                      )}
