...
import {
  CheckCircle, XCircle, X, Package, Search, Sparkles, Pill, Droplet, TestTube, Brain, Sun,
  Dumbbell, Scissors, Stethoscope, Ear, Activity, HeartPulse, Smile, ScanBarcode, FileText,
  Package2, Archive, Clock, Loader2
} from "lucide-react"
...
export default function DaftarObat() {
  ...
  const [modalData, setModalData] = useState<VerificationResponse | null>(null)
  ...
  const handleYOLODetected = async (data: VerificationResponse) => {
    try {
      setModalData(data)
                  ...
                  <div className="bg-gradient-to-r from-teal-500 to-cyan-500 px-6 py-4 text-white relative">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-teal-100 text-sm">Informasi lengkap produk hasil pencarian</p>
                      </div>
                    </motion.div>
                  </div>
                  <div className="p-6">
                    ...
                    >
                      ...
                      >
                        ...
                        Status: {modalData.status || "Unknown"}
                      </div>
                    </motion.div>
                  ...
                  <div className="p-8 text-center">
                    ...
                    >
                      ...
                      <p className="text-gray-600 text-sm max-w-md mx-auto">
                        Gunakan fitur pencarian atau scan label untuk melihat detail produk obat
                      </p>
                    </motion.div>
                    <motion.div
                      initial={{ y: 20, opacity: 0 }}
