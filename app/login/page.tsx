...
import { Eye, EyeOff, ChevronLeft, ChevronRight, ArrowLeft, X, Construction, Info } from "lucide-react"
    ...
    <>
      <div className="w-full max-w-md">
        ...
        <motion.div
          ...
          className="bg-teal-100  mb-5 text-teal-600 p-4 max-w-lg w-full rounded-xl"
        >
          <div className="flex items-start">
            <Info className="w-6 h-6 mr-3 mt-1 flex-shrink-0" />
            <p className="text-sm">
              <span className="font-bold">Perhatian:</span> Jika anda login menggunakan OAuth Google, diharapkan setelah login merefresh halaman.
            </p>
          </div>
        </motion.div>
