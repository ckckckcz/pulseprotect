...
export default function AntiFakeMedicineGames() {
  ...
  const [memoryCards, setMemoryCards] = useState<
    Array<{ id: number; flipped: boolean; matched: boolean; image: string; pairKey: string }>
  >([])
  ...
  // responsive layout handled with flex-wrap and fixed card width
  ...
  const initializeMemoryGame = (difficulty: Difficulty = selectedDifficulty) => {
    ...
    for (let i = 0; i < config.pairs; i++) {
      ...
      cards.push(
        { id: i * 2, flipped: false, matched: false, image: imagePath, pairKey },
        { id: i * 2 + 1, flipped: false, matched: false, image: imagePath, pairKey },
      )
    }
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="rounded-xl bg-white text-black border border-gray-200 hover:bg-gray-100 hover:text-black px-4 py-6 text-sm font-medium flex items-center gap-2">
                          <span
                            className={`${selectedDifficulty === "easy" ? "bg-green-500" : selectedDifficulty === "medium" ? "bg-yellow-500" : "bg-red-500"} inline-block w-2.5 h-2.5 rounded-full`}
                          />
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <Button
                        ...
                        className={`py-6 text-lg font-semibold rounded-2xl transition-all ${selectedAnswer === "asli"
                      ...
                      <Button
                        ...
                        disabled={selectedAnswer !== null}
                        className={`py-6 text-lg font-semibold rounded-2xl transition-all ${selectedAnswer === "palsu"
      ...
      <div className="min-h-screen bg-white mt-24">
        ...
        <div className="py-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto">
              ...
              <div className="max-w-5xl mx-auto">
                <div className="flex flex-wrap gap-4 justify-center">
                  {memoryCards.map((card, index) => (
                    ...
                    >
                      <div
                        className={`relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] ${card.flipped || card.matched ? '[transform:rotateY(180deg)]' : ''}`}
                      >
            ...
            <div className="text-center">
              <Button
                onClick={() => initializeMemoryGame(selectedDifficulty)}
